  ...
  return (
    <div className={cn("space-y-2 text-muted-foreground", className)}>
      {items.map((item, i) => (
        <div
          key={item.id}
          className="group flex h-14 w-full cursor-pointer items-center justify-between rounded-md px-2 text-sm transition-shadow duration-150 hover:shadow-md lg:border lg:pl-0 lg:pr-4 lg:shadow-sm"
        >
